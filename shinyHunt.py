...
def compareFrames(toCompare, pokemonName):
    # Get standard pokemon image
    standardImg = cv2.imread('assets/{0}/{0}Standard.jpg'.format(pokemonName))
    # Convert to HSV
    ...
    while True:
        ...
        if checkShiny:
            ...
            if validFrame(frame, template):
                ...
                val = compareFrames(toCompare, pokemon)
                counter+=1
